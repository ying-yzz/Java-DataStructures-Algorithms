...
public class TestEficiencia {
    ...
    public static final String DIR_FILE_INPUT = BuscadorBD.dirListaLibros;
    public static final String DIR_LIBROS = BuscadorBD.dirLibros;
    
    public static final String DIR_OUTPUT = BuscadorBD.dirListaLibros + "res";
    ...
    public static void main(String[] args) { 
        ...
        /*
        else if (args[1].toLowerCase().equals("con") && !TablaHash.getRehashing()) {
        ...
        else if (args[1].toLowerCase().equals("sin") && TablaHash.getRehashing()) {
                System.out.println("\tERROR: la version de la clase TablaHash que usas\n" +
        ...
        */
            ...
            TablaHash.setRehashing(args[1].equalsIgnoreCase("con"));
            baseHashCode = args[0]; 
    ...
    private static boolean extraerClavesDe(String nomLibro, TablaHash<Termino, Termino> t, int baseHC)  {
        ...
        try {            
            ...
            while (libro.hasNext()) {
                ...
                String[] palabras = linea.split(BuscadorBD.separadores);
                for (int i = 0; i < palabras.length; i++) {   
                    if (Termino.esValido(palabras[i])) {
